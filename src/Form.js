...
class Form extends React.Component {
  ...
  <div>
    ...
    <div className="headerSmall">You use this number as your (please check all that apply)</div>
    <label>
      <input
        type="checkbox"
    ...
    <br />
    <label>
      To file a complaint, you must know the name or phone number of the organization.
      <br />
    ...
    <br />
    <br />
    <div className="headerSmall">If they gave you any of the following, please enter it here:</div>
    <label>
      Mailing address:
      <input
        name="callerAddress"
    ...
    <br />
    <div className="headerSmall">What was the expressed reason for the call? (check all that apply)</div>
    <label>
      <input
        type="checkbox"
        name="reasonSell"
    ...
    <br />
    <div className="headerSmall">What other business, if any, have you done with this organization? (please check all that apply)</div>
    <br />
    <label>
      <input
        type="checkbox"
    ...
    <br />
    <div className="headerSmall">Have you asked not to be called again? (please check all that apply)</div>
    <br />
    <label>
      <input
        type="checkbox"
    ...
    <br />
    <br />
    <div>Before your request can be completed, a security check must 
      be performed. This is to prevent unauthorized access to the National DNCL. To submit your complaint, please click the box below.</div>
    <br />
    <div>
      “I consent to the CRTC collecting the personal information I have provided in this complaint” The types of information collected can be found in the National DNCL Personal Information Bank on Infosource at
      {' '}
      <a href="https://crtc.gc.ca/eng/about/sources.htm">https://crtc.gc.ca/eng/about/sources.htm</a>
